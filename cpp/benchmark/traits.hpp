...
struct traits_t<float> {
  ...
  amaru_compact(float const value) {
    amaru_float_to_amaru_decimal_compact(value);
  }

  static
  void
  amaru_full(float const value) {
    amaru_float_to_amaru_decimal_full(value);
  }
...
struct traits_t<double> {
  ...
  amaru_compact(double const value) {
    amaru_double_to_amaru_decimal_compact(value);
  }

  static
  void
  amaru_full(double const value) {
    amaru_double_to_amaru_decimal_full(value);
  }
