...
#ifndef TEJU_CPP_COMMON_INCLUDE_COMMON_DRAGONBOX_HPP_
#define TEJU_CPP_COMMON_INCLUDE_COMMON_DRAGONBOX_HPP_
...
#endif // TEJU_CPP_COMMON_INCLUDE_COMMON_DRAGONBOX_HPP_
